        ...
        while has_next_page:
            ...
            for cell in product_cells:
                try:
                    ...
                    # --- FILTER LOGIC START ---
                    # Skip products containing "combo" OR both keyboard and mouse
                    title_lower = title.lower()
                    if "combo" in title_lower or ("keyboard" in title_lower and "mouse" in title_lower):
                        print(f"Skipping combo/bundle: {title[:30]}...")
                        continue
                    # --- FILTER LOGIC END ---
